	...
	struct {
		...
		/* === Control fields === */
		{
			...
			VMCS_CF_PPBVMEC_HLT_EXITING |
				...
				VMCS_CF_PPBVMEC_USE_MSR_BITMAPS |
		...
		},
		{
			...
			VMCS_CF_SPBVMEC_ENABLE_EPT |
				VMCS_CF_SPBVMEC_UNRESTRICTED_GUEST |
				VMCS_CF_SPBVMEC_ENABLE_INVPCID |
				VMCS_CF_SPBVMEC_ENABLE_XSAVES_XRSTORS,
			IA32_VMX_PROCBASED_CTLS2,
		},

		{VMCS_CF_ADDRESS_OF_MSR_BITMAPS, vmx_get_msr_bitmaps_page(), 0},
		{VMCS_CF_XSS_EXITING_BITMAP, 0, 0},
		...
		{
			VMCS_CF_PRIMARY_VM_EXIT_CONTROLS,
			VMCS_CF_VMEX_HOST_ADDRESS_SPACE_SIZE | VMCS_CF_VMEX_SAVE_IA32_EFER | VMCS_CF_VMEX_LOAD_IA32_EFER,
			IA32_VMX_EXIT_CTLS,
		},
		...
		{
			VMCS_CF_VM_ENTRY_CONTROLS,
			VMCS_CF_VMEN_IA_32E_MODE_GUEST | VMCS_CF_VMEN_LOAD_IA32_EFER,
			IA32_VMX_ENTRY_CTLS,
		},
		...
		{VMCS_HOST_IA32_EFER, rdmsr(IA32_EFER), 0},
		...
		{VMCS_GUEST_IA32_EFER, config->guest_state.ia32_efer, 0},
